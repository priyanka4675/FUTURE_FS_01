  ...
  return (
    <section id="projects" className="projects section" ref={sectionRef}>
        ...
        {filtered.map((project, i) => (
          ...
          >
            ...
            <div className="project-footer">
              <button className="proj-btn" onClick={() => window.open('https://github.com/priyanka-pilla999', '_blank')}>
      ...
      <div className="projects-cta reveal">
        ...
        <a href="https://github.com/priyanka-pilla999" target="_blank" rel="noopener noreferrer" className="github-link">
